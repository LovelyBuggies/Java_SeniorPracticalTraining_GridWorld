          ...
          for (Actor a : actors) {
            // move to the direc0 location
             if (a.getLocation().equals(loc.getAdjacentLocation(getDirection() + direc[0]))) {
                 Location tmploc = a.getLocation().getAdjacentLocation(getDirection() + direc[0]);
                 if(gr.isValid(tmploc) && gr.get(tmploc) == null) {
                    a.moveTo(tmploc);
                  } 
                  else {
              ...
              // move to the direc1 location
                 ...
                 Location tmploc = a.getLocation().getAdjacentLocation(getDirection() + direc[1]);
                 if(gr.isValid(tmploc) && gr.get(tmploc) == null) {
                    a.moveTo(tmploc);
                  } 
                  else {
              ...
              // move to the direc2 location
                 ...
                 Location tmploc = a.getLocation().getAdjacentLocation(getDirection() + direc[2]);
                 if(gr.isValid(tmploc) && gr.get(tmploc) == null) {
                    a.moveTo(tmploc);
                  } 
                  else {
